...
export function Ribbon({ size = 24, strokeWidth = 2, className, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
      viewBox="-4 -1.0008 24 24"
      fill="none"
